...
The interface is in Armenian. Self-hosted fonts are included with their licenses: Noto Sans Armenian and Mardoto. The product images and three flavour examples are illustrative design assets. Check the café's current menu and product photography before using them as factual listings.
