...
The interface is in Armenian. Self-hosted fonts are included with their licenses: Noto Sans Armenian and Mardoto. The two tiramisu menu photos are AI-generated illustrative assets; the flavour examples are illustrative as well. Check the café's current menu and product photography before using them as factual listings.
